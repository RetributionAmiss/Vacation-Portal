...
assert(server.includes("outcome: 'disabled'"));
assert(server.includes("outcome: 'not-configured'"));
...
assert(server.includes('smartReminderBuildPushPayload_(context, travelerId, items)'));
